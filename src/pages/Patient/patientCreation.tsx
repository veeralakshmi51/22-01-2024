...
const PatientCreation: React.FC = () => {
  ...
  return (
    ...
    <h4 className='mb-2 text-center' >Patient Details</h4>
    <hr></hr>
    <div className="row w-100 " style={{marginTop:'10px'}}>
        ...
        <div className="d-flex gap-3 justify-content-end mt-4">
          <Button label="Cancel" onClick={() => { navigate('/management/patient-table') }} severity="secondary" style={{ color: '#000', backgroundColor: '#fff', border: '2px solid #0f3995' }} />
